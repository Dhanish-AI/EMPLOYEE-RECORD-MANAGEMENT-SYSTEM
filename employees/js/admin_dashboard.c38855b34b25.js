(function () {
  ...
  function initCharts() {
    ...
    const textColor = styles.getPropertyValue('color').trim() || '#1f2937';
    ...
    Chart.defaults.font.family = styles.getPropertyValue('font-family').trim() || "'Poppins','Segoe UI',sans-serif";
